...
launch_keycloak () {
  ...
  count=1
  limit=150
  until docker-compose -f docker-compose-services.yml exec -T mlr-keycloak curl -fk --silent --show-error --max-time 1 https://mlr-keycloak:9443/auth/realms/mlr/protocol/openid-connect/certs; do
